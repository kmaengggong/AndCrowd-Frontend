...
const CrowdQnaList = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const qnaResponse = await fetch(`/crowd/${crowdId}/qna/all`);
                if(qnaResponse.ok) {
                    const qnaData = await qnaResponse.json();
                    setCrowdQna(qnaData);
                    const crowdQnaId = qnaData.crowdQnaId;
                }else {
        ...
        <div id='qna-container'>
            ...
            <div id='qna-box'>
                ...
                <div className="create">
                    <Button onClick={() => createQna(crowdId)}
                                ...
                                <Box sx={{ padding: 2, background: '#f6f8f6' }}>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            onClick={() => deleteCrowdQna(crowdId, crowdQna.crowdQnaId)}>삭제</Button>
                                                ...
                                                <React.Fragment key={comment.qnaReplyId}>
                                                    ...
                                                    <TableCell sx={{ width: '45%', paddingBottom: 2, paddingTop: 2 }}>
                                                        ...
                                                        <Box sx={style}>
                                                            ...
                                                            type="text" name="andReplyContent" value={replyFormData.qnaReplyContent} 
            ...
            <Button to={`/crowd/${crowdId}/qna/`}>글 작성</Button>
        </div>
    );
};
